...
----------------------------------------------------------------------------------------------------
  ...
  This folder contains the ground water quality (GWQ) indicator scoring script, along with a table of 
MCLs and a folder with the 2020 census blocks that reside in the 263 meter screening area.
